...
const SHEET_NAME = 'BusinessTrips';
const ID_KEY = 'id';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ message: 'Business trip added successfully' });
  } catch (error) {
    console.error('API Error (POST):', error);
    return NextResponse.json({ error: 'Failed to add business trip' }, { status: 500 });
  }
}
...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ message: 'Business trip updated successfully' });
  } catch (error) {
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ message: 'Business trip deleted successfully' });
  } catch (error) {
